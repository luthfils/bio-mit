        ...
        <div id="wrapper" class="clearfix">
            ...
            <section id="slider" class="slider-element min-vh-100 bgchanger include-header bg-dark hero">
                <div class="slider-inner">
                    ...
                    <a data-scroll href="#section-about" class="one-page-arrow d-none d-md-block">
            ...
            <section id="content">
                <div class="content-wrap py-0">
                    ...
                    <div id="section-event" class="page-section journey pt-6 bg-dark-2">
                        ...
                        <h5 class="text-uppercase ls4 fw-normal mb-3 fc-secondary text-center wow fadeInUp" data-wow-delay="100ms">Journey</h5>

                        <h2 class="center mb-3 text-capitalize fw-bold font-body wow fadeInUp" data-wow-delay="200ms">Hackathon Journey</h2>

                        <div class="row mt-6 gy-lg-0 gy-4">
                            <div class="col-12 col-sm-4 col-lg">
                                <div class="card-journey p-4 center wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="col-12 col-sm-4 col-lg">
                                <div class="card-journey p-4 center wow fadeInUp" data-wow-delay="400ms">
                                    <div class="square-icon fw-bold">
                                        2
                                    </div>
                                    <div class="icon my-4">
                            ...
                            <div class="col-12 col-sm-4 col-lg">
                                <div class="card-journey p-4 center wow fadeInUp" data-wow-delay="500ms">
                                    <div class="square-icon fw-bold">
                                        3
                                    </div>
                                    <div class="icon my-4">
                            ...
                            <div class="col-12 col-sm">
                                <div class="card-journey p-4 center wow fadeInUp" data-wow-delay="600ms">
                                    <div class="square-icon fw-bold">
                                        4
                                    </div>
                                    <div class="icon my-4">
                            ...
                            <div class="col-12 col-sm">
                                <div class="card-journey p-4 center wow fadeInUp" data-wow-delay="700ms">
                                    <div class="square-icon fw-bold">
                                        5
                                    </div>
                                    <div class="icon my-4">
                    ...
                    <div id="section-timeline" class="page-section timeline bg-dark pt-6">
                        <div class="container clearfix">
                            ...
                            <h5 class="text-uppercase ls4 fw-normal mb-3 fc-secondary text-center wow fadeInUp" data-wow-delay="100ms">Agenda</h5>

                            <h2 class="center mb-3 text-capitalize fw-bold font-body wow fadeInUp" data-wow-delay="200ms">Hackathon Agenda</h2>
                                    ...
                                    <div class="col-md-6 sticky-sidebar-wrap">
                                        <div class="sticky-sidebar">
                                            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a data-wow-delay="300ms" class="nav-link d-flex wow fadeInUp active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                    <div class="me-4">
                            ...
                            <div class="d-md-none d-md-block">
                                <div class="accordion mb-0 mt-6">
                                    ...
                                    <div class="accordion-card wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="container">
                                ...
                                <div class="row align-items-center gutter-40">
                                    <div class="col-md-6">
                                        ...
                                        <h4 class="mb-4 wow fadeInUp" data-wow-delay="300ms">Pharmaceutical & Biotechnology</h4>
                                    ...
                                    <div class="col-md-6">
                                        <h2 class="text-capitalize fw-bold font-body mb-2 wow fadeInUp" data-wow-delay="400ms">Downstream</h2>
                                        <h4 class="mb-4 wow fadeInUp" data-wow-delay="500ms">Healthcare Providers & Retailers</h4>
                    ...
                    <div id="section-partner" class="page-section partner bg-dark pt-6">
                        <div class="container clearfix">
                            ...
                            <div class="center">
                                <h5 class="text-uppercase ls4 fw-normal mb-2 fc-secondary wow fadeInUp" data-wow-delay="100ms">Partners</h5>
                                <h2 class="text-capitalize fw-bold font-body wow fadeInUp" data-wow-delay="200ms">Our Partners are Indonesia’s topmost healthcare and digital Organizations & Companies</h2>
                            </div>
